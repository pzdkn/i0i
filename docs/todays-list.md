...
1. [RFC 0124: Simple incremental Project Research](rfcs/projects/0124-simple-incremental-project-research.md)
   — reduce the Harness to one instruction, one Run action, automatic Project
   enrichment, contextual details, and progressively disclosed Activity.
...
1. [RFC 0123: Reliable Harness planner responses and Run smoke test](rfcs/projects/0123-reliable-harness-planner-responses-and-run-smoke-test.md)
...
2. [RFC 0122: Run finalization at the safe boundary](rfcs/projects/0122-run-finalization-safe-boundary.md)
   ...
   durable.
3. [RFC 0121: Production operational reflection](rfcs/projects/0121-production-operational-reflection.md)
   ...
   improvements.
4. [RFC 0120: State-informed Run orientation](rfcs/projects/0120-state-informed-run-orientation.md)
...
5. [RFC 0108: Project-scoped autonomous research harness](rfcs/projects/0108-project-scoped-autonomous-research-harness.md)
...
6. [RFC 0119: Research workspace conformance and accessibility](rfcs/projects/0119-research-workspace-conformance-and-accessibility.md)
...
7. [RFC 0118: Durable Run checkpoints and structured Activity](rfcs/projects/0118-durable-run-checkpoints-and-structured-activity.md)
...
8. [RFC 0117: Autonomous Run reconciliation and review](rfcs/projects/0117-autonomous-run-reconciliation-and-review.md)
...
9. [RFC 0116: Harness authority and effective instructions](rfcs/projects/0116-harness-authority-and-effective-instructions.md)
...
10. [RFC 0115: Create Project documents from research](rfcs/projects/0115-create-project-documents-from-research.md)
...
11. [RFC 0114: Harness reflection and improvement proposals](rfcs/projects/0114-harness-reflection-and-improvement-proposals.md)
...
12. [RFC 0113: Scheduled Research Runs and stopping](rfcs/projects/0113-scheduled-research-runs-and-stopping.md)
...
13. [RFC 0112: Typed Research State and evidence links](rfcs/projects/0112-typed-research-state-and-evidence-links.md)
...
14. [RFC 0111: Research Harness configuration and manual Runs](rfcs/projects/0111-research-harness-configuration-and-manual-runs.md)
...
15. [RFC 0110: Project Markdown documents](rfcs/projects/0110-project-markdown-documents.md)
...
16. [RFC 0109: Project and Vault ownership migration](rfcs/projects/0109-project-vault-ownership-migration.md)
   ...
   actions.
17. [RFC 0100: Eager Obscura startup and discovery gate](rfcs/source-acquisition/0100-eager-obscura-startup-and-discovery-gate.md)
...
18. [RFC 0101: Honest chat web-search routing](rfcs/chat/0101-honest-chat-web-search-routing.md)
...
19. [RFC 0096: Fluid PDF highlight rendering](rfcs/reader/0096-fluid-pdf-highlight-rendering.md)
   — implementation is landed; manual PDF visual checks remain.
20. [RFC 0097: Research-connected chat with epistemic boundaries](rfcs/chat/0097-research-connected-chat-with-epistemic-boundaries.md)
   — production paths are landed; the live prompt-quality comparison remains.
21. [RFC 0098: Browser-first scholarly discovery](rfcs/discovery/0098-browser-first-scholarly-discovery.md)
   — production paths are landed; the fixed-corpus live migration benchmark
   remains.
22. [RFC 0099: Reliable math in chat and notes](rfcs/chat/0099-reliable-math-in-chat-and-notes.md)
