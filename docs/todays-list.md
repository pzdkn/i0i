...
5. [RFC 0052: Reliable Obscura sessions and web-reader fallback](rfcs/source-acquisition/0052-reliable-obscura-and-web-reader-fallback.md)
   ...
   0098.
6. [RFC 0087: Dead paths in vault surfaces](rfcs/frontend-and-mocking/0087-dead-paths-in-the-vault-surfaces.md)
   — implement **Ask this vault**; the other sections have landed.
7. [RFC 0088: Deep Research harness](rfcs/discovery/0088-deep-research-harness.md)
...
8. [RFC 0089: Paper quiz](rfcs/study/0089-paper-quiz.md)
   — add paper-grounded quiz generation, grading, and quiz sessions.
9. [RFC 0090: Paper references in notes](rfcs/reader/0090-paper-references-in-notes.md)
   — finish the `[@` paper autocomplete interaction.
10. [RFC 0092: Weekly digest](rfcs/study/0092-weekly-digest.md)
   — summarize the user's actual reading, notes, questions, and quiz activity.
11. [RFC 0093: Study mode](rfcs/study/0093-study-mode.md)
